...
public class NewsSimpleService1 extends Service {
    ...
    */
    ...
    public  int onStartCommand(Intent intent, int flags, int startId){
        ...
        if(subThread == null) // 만 해주면 됨 메모리 누수가 발생할 수 있음 조심하자
...
//                    message = " sleep() 도중 인터럽트 발생!";
                    newsMessage.what = 9;
                    newsMessage.obj = " sleep() 도중 인터럽트 발생!";
                    // 주로 스레드를 죽일 때 이런 방법을 많이 사용함. 한 번 죽이고 exception이 발생하면 한 번 다시 interrupt 해 줌
